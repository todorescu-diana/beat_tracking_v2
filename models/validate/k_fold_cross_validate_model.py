...
from utils.validate_model_utils import k_fold_cross_validation, validate

dataset_name = VALID_DATASET_NAMES[1]
...
if dataset_tracks is not None:
    ...
    validate(model_name='aam_gtzan_rhythm_ballroom', test_tracks=dataset_tracks, test_dataset_name=dataset_name, results_dir_path=RESULTS_DIR_PATH)