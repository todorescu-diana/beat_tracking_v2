...
class LinearSpectrogramProcessor(SpectrogramProcessorBase):
    ...
    def plot_spectrogram(self, spectrogram, duration_s=None, cmap='gist_heat'):
        ...
        librosa.display.specshow(spectrogram.T, sr=self.sample_rate, hop_length=self.hop_length, x_axis='time', y_axis='hz',
                                 fmin=F_MIN, fmax=F_MAX)
        plt.set_cmap(cmap)
        plt.ylim(self.f_min, 8192)
