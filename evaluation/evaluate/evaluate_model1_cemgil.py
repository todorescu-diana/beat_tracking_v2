...
# cemgil = mir_eval.beat.continuity(v.beats.times, det[k]['beats'])
...
# print("my continuity: ", cemgil)    # only original metrical level

# print("custom mean cemgil: ", cemgil_helper.calculate_mean_metric(det, {k: {'beats': v.beats.times}}))

cemgil_helper.plot_beats(det[k]['beats'], v.beats.times, n=5)
